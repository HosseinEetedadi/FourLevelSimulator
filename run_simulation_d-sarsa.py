...
def simulate(env):
    ...
    if MULTI_CLUSTER:
        ...
        nodes.append(create_node(env, 14, 3, 2, Node.NodeType.UP_SCHEDULER, 1.0))
        nodes.append(create_node(env, 15, 3, 2, Node.NodeType.UP_WORKER, 0.98))
        nodes.append(create_node(env, 16, 3, 2, Node.NodeType.UP_WORKER, 0.99))
        nodes.append(create_node(env, 17, 3, 2, Node.NodeType.UP_WORKER, 0.99))
